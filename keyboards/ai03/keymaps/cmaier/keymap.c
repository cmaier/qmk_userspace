...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_SPACE_FN] = LAYOUT_all(
     ...
     KC_SWTR, XXXXXXX, KC_PGUP, XXXXXXX, XXXXXXX, XXXXXXX, KC_PGUP, KC_HOME,  KC_END, XXXXXXX, XXXXXXX, KC_TBAK, KC_TFWD,          XXXXXXX,
     _______, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, XXXXXXX, XXXXXXX,                   XXXXXXX,
     _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  KC_SPC, KC_PGDN, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX,
     _______, _______, _______, XXXXXXX,                        XXXXXXX,                       XXXXXXX, _______, _______, _______, XXXXXXX
  ),
  ...
  [_GAMING] = LAYOUT_all(
     ...
     KC_LSFT, KC_BSLS,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,          KC_RSFT, XXXXXXX,
     KC_LCTL, KC_LGUI, KC_LALT, XXXXXXX,                         KC_SPC,                       XXXXXXX, KC_RALT, KC_RGUI, KC_RCTL, TD(TD_FN)
  ),
  ...
  [_GAMING_FN] = LAYOUT_all(
     ...
     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  KC_SPC, KC_PGDN, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX,
     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                        XXXXXXX,                       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
  ...
  [_GAMING_MEDIA] = LAYOUT_all(
     ...
     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  KC_SPC, KC_PGDN, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          KC_TERM, XXXXXXX,
     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                        XXXXXXX,                       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
