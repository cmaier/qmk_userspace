...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_all(
     ...
     KC_LCTL, KC_LALT, KC_LGUI, XXXXXXX,                         KC_SFN,                       XXXXXXX, KC_RGUI, KC_RALT, KC_RCTL,  KC_MAC
  ),
  ...
  [_KEYBOARD_CONFIG] = LAYOUT_all(
     ...
     XXXXXXX, XXXXXXX, KC_BASE, XXXXXXX, XXXXXXX, KC_VRSN, XXXXXXX, XXXXXXX, KC_MAKE, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX,
     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                        XXXXXXX,                       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  )
};
