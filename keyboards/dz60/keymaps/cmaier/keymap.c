...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_60_ansi(
     ...
     KC_LSFT,    KC_Z,    KC_X,    LP_C,    LP_V,    KC_B,    LP_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,                   KC_RSFT,
     KC_LCTL, KC_LALT, KC_LGUI,                             LT_SFN,                            KC_RGUI, KC_RALT, KC_RCTL,  MO_MAC
  ),
  ...
  [_MACOS_FN] = LAYOUT_60_ansi(
     ...
     _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   KC_TERM,
...
XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  ...
  [_GAMING] = LAYOUT_60_ansi(
     ...
     KC_LCTL, KC_LGUI, KC_LALT,                             KC_SPC,                            KC_RALT, KC_RGUI, KC_RCTL, TD(TD_FN)
  ),
...
XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, QK_BOOT,
     ...
     XXXXXXX, TO_BASE, XXXXXXX, XXXXXXX, KC_VRSN, XXXXXXX, XXXXXXX, KC_MAKE, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX,
     XXXXXXX, XXXXXXX, XXXXXXX,                            XXXXXXX,                            XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  )
};
