...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_60_ansi(
     ...
     MO_INTJ,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT,           KC_ENT,
  ...
  [_SPACE_FN] = LAYOUT_60_ansi(
     ...
     KC_SWTR, XXXXXXX,   KC_UP, XXXXXXX, XXXXXXX, XXXXXXX, KC_PGUP, KC_HOME,  KC_END, XXXXXXX, XXXXXXX, KC_TBAK, KC_TFWD, XXXXXXX,
     _______, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, XXXXXXX, XXXXXXX,          XXXXXXX,
     _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  KC_SPC, KC_PGDN, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX,
